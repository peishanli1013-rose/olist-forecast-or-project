...
def main():
    ...
    for policy in ("last_week", "moving_average", "ridge"):
        ...
        weekly, flows = run_policy_backtest(policy, panel, forecasts, network, settings, scenario="base")
    ...
    create_figures(panel, metrics, all_weekly, all_summary, sensitivity_summary, figures_dir)
    write_results_report(audit, metrics, all_summary, sensitivity_summary, output_dir / "RESULTS_SUMMARY.md")
